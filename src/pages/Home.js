    ...
    <div>
      <div className="h-40 md:h-56 flex items-center justify-center hero sticky top-0 z-10">
        <div className="w-2/3 md:w-3/4">
          ...
          <p className="text-xl sm:text-2xl md:text-3xl font-thin text-white">
            Get to know the latest updates on current covid-19 cases around the world!
          </p>
          <input
            type="text"
            placeholder="Search by country name"
            className="py-3 px-5 mt-3 focus:outline-grey-500 rounded-full w-full md:3/4 lg:w-2/5"
            value={searchText}
